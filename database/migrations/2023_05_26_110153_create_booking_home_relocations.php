...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('booking_home_relocations', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('property_from_type')->nullable();
            $table->string('property_to_type')->nullable();
            $table->string('no_of_bedrooms_from')->nullable();
            $table->string('no_of_bedrooms_to')->nullable();
    ...
    {
        Schema::dropIfExists('booking_home_relocations');
    }
};
