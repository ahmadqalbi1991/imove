            ...
            <div class="card-body py-0">
                            ...
                            <div class = "row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ isset($booking->booking_home_relocation->move_out_date) ? date( 'd M,Y',strtotime($booking->booking_home_relocation->move_out_date) ): '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->country_from ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->city_from ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->area_from ?? ''}}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->building_from_name ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->building_from_no ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->property_from_type ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->no_of_bedrooms_from ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->handyman_services_to_dismantle ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->extra_details_from ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->details_of_items_to_be_excluded ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->include_insurance ?? '' }}
                                    </div>      
                                </div>
                        ...
                        <div class = "col-md-6 moving-to">
                            <div class = "row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ isset($booking->booking_home_relocation->move_in_date) ? date( 'd M,Y',strtotime($booking->booking_home_relocation->move_in_date) ): '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label class="form-label">Country</label>
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->country_to ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label class="form-label">City</label>
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->city_to ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    <label class="form-label">Area</label>
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->area_to ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Building Name</label>
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->building_to_name ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Building No.</label>
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->building_to_no ?? ''}}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Property Type</label>
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->property_to_type ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Number of Bedrooms</label>
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->no_of_bedrooms_to ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->handyman_services_to_assemble ?? '' }}
                                    </div>      
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-control-plaintext" >
                                        {{ $booking->booking_home_relocation->extra_details_to ?? '' }}
                                    </div>      
                                </div>
                ...
                <div class = "row mt-2">
                    <div class = "col-md-12 mt-2 mb-2">
                        <div class="title_lines">Uploaded Pictures of Rooms</div>
                    </div>
    ...
    <script>
        ...
        function calculateAndDisplayRoute(directionsService, directionsDisplay) {
            directionsService.route({
                origin: new google.maps.LatLng("{{ $booking->booking_home_relocation->latitude_from ?? '' }}", "{{ $booking->booking_home_relocation->longitude_from ?? ''}}"),
                destination: new google.maps.LatLng("{{ $booking->booking_home_relocation->latitude_to ?? '' }}", "{{ $booking->booking_home_relocation->longitude_to ?? '' }}"),
                travelMode: 'DRIVING'
