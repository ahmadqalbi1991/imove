                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <p>{{replace_plus($datamain->dail_code.' '.$datamain->mobile_no)}}</p>
...
<div class="card mb-3">
        ...
        <div class="card-body">
                    ...
                    <div class=" form-group imgs-wrap">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 img-wrap position=relative">
                                    ...
                                    <img style="width: 205px; height: 110px; border-radius: 5px; object-fit: cover;" class="img-responsive w-100" src="{{ asset($img->image) }}">
                                </div>
                                @endforeach
        ...
        <h5 class="card-header mb-0">Driver Details</h5>
                            <div class="card-body">
                                <div class="">
                                    <div class="form-group">
                                        ...
                                        <select name="pickup_driver" id="pickup_driver" disabled required {{!empty($datamain->booking_status) && $datamain->booking_status >= 4 ? 'disabled' : '';}}>
                        ...
                        <div class="" style="display:none;">
                            <div class="form-group">
                                ...
                                <select name="booking_status" id="booking_status" readonly>
                        ...
                        <div class="">
                            <div class="form-group">
                                <label>Driver Comment</label>
                                <p>{{$datamain->comment}}</p>
                            </div>
                        </div>
                        ...
                        <div class="">
                            <div class="form-group">
                               ...
                               <img src="{{$datamain->signature}}" width="200px">
                            </div>
                        </div>
                        @endif
                            </div>
                            ...
                            <table class="table table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th style ="text-align:right; border-top: none;">AED <span id="cost">{{number_format($datamain->cost??0, 2, '.', '')}}</span> </th>
