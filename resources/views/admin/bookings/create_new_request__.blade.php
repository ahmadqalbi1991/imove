...
<link href="{{ asset('') }}admin-assets/jquery.timepicker.min.css" rel="stylesheet" type="text/css" />
    <div class="card mb-5">
        ...
        <div class="card-body">
        <form method="post" id="admin-form1" action="{{ route('admin.bookings.create_new_request_store') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea cols="30" rows="4" class="form-control-plaintext" data-jqv-required="true" id="description" name="description" required>{{ $datamain->description ?? '' }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea cols="30" rows="4" class="form-control-plaintext" data-jqv-required="true" id="instruction" name="instruction" required>{{ $datamain->instruction ?? '' }}</textarea>
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control-plaintext flatpicker-input" data-jqv-required="true" id="date" name="date" required value="{{ $datamain->date ?? '' }}" />
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="delivery_type" id="delivery_type" required onchange="CostCalculation()">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="pickup_driver" id="pickup_driver" {{!empty($datamain->booking_status) && $datamain->booking_status >= 4 ? 'disabled' : '';}}>
                        ...
                        <div class="col-md-6" style="display:none;">
                            <div class="form-group">
                                ...
                                <select name="booking_status" id="booking_status">
                                    ...
                                    <option value="1"  {{!empty($datamain->booking_status) && $datamain->booking_status >= 1 ? 'disabled' : '';}} {{!empty($datamain->booking_status) && $datamain->booking_status == 1 ? 'selected' : null;}}>{{booking_status(1)}}</option>
                                    <option value="4" {{!empty($datamain->booking_status) && $datamain->booking_status >= 4 && $datamain->booking_status <= 1 ? 'disabled' : '';}} {{!empty($datamain->booking_status) && $datamain->booking_status >= 4 ? 'selected' : null;}}>{{booking_status(4)}}</option>
                                   </select>
                            </div>
                        </div>
                        @if(!empty($datamain->booking_status) && $datamain->booking_status >= 4)
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="delivery_driver" id="pickup_driver" required {{!empty($datamain->booking_status) && $datamain->booking_status >= 8 ? 'disabled' : '';}}>
                                    <option value="">Select</option>
                                    @foreach($drivers as $value)
                                    <option value="{{$value->id}}"  {{!empty($datamain->delivery_driver) && $datamain->delivery_driver == $value->id ? 'selected' : null;}}>{{$value->name}}</option>
                                    @endforeach
                                   </select>
                            </div>
                            @if($datamain->booking_status >= 8)
                            <input type="hidden" value="{{$datamain->delivery_driver}}" name="delivery_driver" >
                            @endif
                        </div>
                    ...
                    <div class="col-md-12 form-group imgs-wrap">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 img-wrap position=relative">
                                    ...
                                    <img style="width: 100%; height: 150px; border-radius: 5px; object-fit: cover;" class="img-responsive w-100" src="{{ asset($img->image) }}">
                                </div>
                                @endforeach
        ...
        function CostCalculation()
        {
            ...
            if(category_id > 0 && size_id > 0)
            {
                $.ajax({
                    ...
                    data: {category_id:category_id, size_id:size_id, "_token": "{{ csrf_token() }}","delivery_type":delivery_type},
