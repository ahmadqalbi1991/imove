    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="card">
            ...
            <div class="card-body py-0">
                ...
                <div class = "row mt-2">
                    <div class = "col-md-12">
                        <div class="title_lines">Storage Request Details</div>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Pickup Date</label>
                        <div class="form-control-plaintext" >
                            {{ isset($booking->booking_storage_services->pickup_date) ? date( 'd M,Y',strtotime($booking->booking_storage_services->pickup_date) ): '' }}
                        </div>      
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control-plaintext" >
                            {{ isset($booking->booking_storage_services->start_date) && isset($booking->booking_storage_services->end_date) ? date( 'd M,Y',strtotime($booking->booking_storage_services->start_date) ). " --To-- ".date( 'd M,Y',strtotime($booking->booking_storage_services->end_date) ) : '' }}
                        </div>      
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control-plaintext" >
                            {{ $booking->booking_storage_services->country ?? '' }}
                        </div>      
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control-plaintext" >
                            {{ $booking->booking_storage_services->city ?? '' }}
                        </div>      
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control-plaintext" >
                            {{ $booking->booking_storage_services->area ?? ''}}
                        </div>      
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control-plaintext" >
                            {{ $booking->booking_storage_services->building_name ?? '' }}
                        </div>      
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control-plaintext" >
                            {{ $booking->booking_storage_services->building_no ?? '' }}
                        </div>      
                    </div>

                    <div class="col-md-6">
                        <label class="form-label">Require Items to be collected and moved to storage?</label>
                        <div class="form-control-plaintext" >
                            {{ $booking->booking_storage_services->items_to_be_collected ?? '' }}
                        </div>      
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control-plaintext" >
                            {{ $booking->booking_storage_services->extra_details ?? '' }}
                        </div>      
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-control-plaintext" >
                            {{ $booking->booking_storage_services->include_insurance ?? '' }}
                        </div>      
                    </div>
                ...
                <div class = "row">
                    <div class="col-md-12">
                    <div class="form-group" value = "{{$booking->booking_storage_services->address ?? ''}}">

                        <x-elements.map-location  
                        addressFieldName="address"
                        :lat="$booking->booking_storage_services->latitude ?? ''"
                        :lng="$booking->booking_storage_services->longitude ?? ''"
                        :address="$booking->booking_storage_services->address ?? ''"
                        />
                        </div>
                    </div>    
                </div>
