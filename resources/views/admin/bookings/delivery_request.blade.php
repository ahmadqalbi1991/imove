...
<div class="container-xxl flex-grow-1 container-p-y">
  ...
  <div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
      ...
      <a href="{{route('admin.bookings.create_new_request')}}" class="main-btn primary-btn btn-hover btn-sm"><i class='bx bx-plus'></i> Create</a>
    </div>
    <div class="card-body">

      
      {{-- data-src="{{route('getnewbookingList',['status' => 'pending'])}}" --}}
      <div class="card-datatable text-nowrap">
        <div class="table-responsive">
          <table class="datatables-ajax table table-condensed" data-searching="true" data-role="ui-datatable" data-src="{{route('admin.bookings.delivery_request_list',['p_driver_id'=>  $_GET["p_driver_id"] ??"",'d_driver_id'=>  $_GET["d_driver_id"] ??"",'cus_id'=>  $_GET["cus_id"] ??"", 'type'=>  $_GET["type"] ??""])}}">
            <thead style="background-color: white !important;">
              <tr>
                <th class="pt-0" data-colname="id">#</th>
                <th class="pt-0" data-colname="order_number"> AWB Number</th>
                <th class="pt-0" data-colname="qr_code"> QR code</th>
                <th class="pt-0" data-colname="category_name"> Category</th>
                <th class="pt-0" data-colname="customer_name"> Customer Name</th>
                <th class="pt-0" data-colname="booking_status"> Status</th>
