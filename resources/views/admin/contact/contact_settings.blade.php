                ...
                <div class=" mt-3">
                    <form method="post" id="admin-form" action="{{route('admin.contact_us_setting_store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">   
                            ...
                            <div class="col-md-6 form-group">
                                <label>TikTok </label>
                                <input type="url" name="tiktok" class="form-control jqv-input" data-jqv-required="true" value="{{$page->tiktok}} " placeholder="Enter Tktok link " >
                            </div>
                            <div class="col-md-6 form-group">
                                <label>SnapChat </label>
                                <input type="url" name="snapchat" class="form-control jqv-input" data-jqv-required="true" value="{{$page->snapchat}} " placeholder="Enter Linkedin link " >
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Website </label>
                                <input type="url" name="website" class="form-control jqv-input" data-jqv-required="true" value="{{$page->website}} " placeholder="Enter website link " >
                            </div>
                            <div class="col-md-6 form-group">
