...
@section('content')
    <div class="card mb-5">
        <div class="card-body">
            <div class="col-xs-12">
                <form method="post" id="admin-form" action="{{ route('categories.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <!--<br><br>-->
                                <input type="file" name="icon" class="form-control" data-role="file-image"
                                    data-preview="image-preview" data-parsley-trigger="change"
                                    data-parsley-fileextension="jpg,png,gif,jpeg,svg"
                                    data-parsley-fileextension-message="Only files with type jpg,png,gif,jpeg,svg are supported"
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res['status'] == 0) {
                        ...
                        setTimeout(function() {
                            window.location.href = App.siteUrl('/admin/categories');
                        }, 1500);
