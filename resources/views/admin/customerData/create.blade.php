...
<div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="card">
                ...
                <form id="admin_form" method="post" action="{{route('customer_csv.submit')}}" enctype="multipart/form-data">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-xs-12 col-sm-6">
                                ...
                                @csrf()
                                <div class="mb-3">
                                <label class="form-label" for="bs-validation-name">Upload Customer Csv<span class="text-danger">*</span> </label>
                                <input
                                    type="file"
