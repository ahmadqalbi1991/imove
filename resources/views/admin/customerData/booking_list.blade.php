                ...
                <div class="card-body">
                  <div class="card-datatable text-nowrap">
                    <div class="table-responsive">
                      <table class="datatables-ajax table table-condensed" data-role="ui-datatable" data-src="{{route('getCustomerBookingList',['id' => $id,'status' => $status] )}}" >
                        <thead>
                            <tr>
                                ...
                                <th class="pt-0" data-colname="qouted_amount"> Company Qoute</th>
                                <th class="pt-0" data-colname="booking_status"> Request Status</th>
                                <th class="pt-0" data-colname="is_paid"> Payment</th>
