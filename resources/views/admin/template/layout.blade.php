...
<aside class="sidebar-nav-wrapper">
    ...
    <nav class="sidebar-nav">
        <ul>
            ...
            <!-- <li class="nav-item @if (in_array(\Route::currentRouteName(), ['users.list', 'users.create', 'users.edit']))
                active
            @endif">
...
--}}
            ...
            @if (get_user_permission('drivers', 'r'))
                <li class="nav-item @if (in_array(\Route::currentRouteName(), ['coupons.list'])) active @endif">
...
--}}
            ...
            <li class="nav-item nav-item-has-children @if ($isAdministration) active @endif">
                ...
                <ul id="ddmenu_2" class="collapse dropdown-nav @if ($isAdministration) show @endif">
                    ...
                    @if(check_permission('manufacturer','View'))
                        <li>
                            <a class="{{preg_match('/admin\/manufacturer/', $CurrentUrl) ? 'active' : null}}"
                               href="{{ url('admin/manufacturer') }}"><span class="text">Make</span></a>
                        </li>
                    @endif

                    @if(check_permission('model','View'))
                        <li>
                            <a class="{{preg_match('/admin\/vehilce\/model/', $CurrentUrl) ? 'active' : null}}"
                               href="{{ url('admin/vehilce/model') }}"><span class="text">Models</span></a>
                        </li>
                    @endif
                    @if(check_permission('model','View'))
                        <li>
                            <a class="{{preg_match('/admin\/vehilce\/type/', $CurrentUrl) ? 'active' : null}}"
                               href="{{ url('admin/vehilce/type') }}"><span class="text">Vehicle Type</span></a>
                        </li>
                    @endif

                    <li>
                        <a class="{{preg_match('/admin\/vehilce\/problems/', $CurrentUrl) ? 'active' : null}}"
                           href="{{ url('admin/vehilce/problems') }}"><span class="text">Emergency Problems</span></a>
                    </li>
