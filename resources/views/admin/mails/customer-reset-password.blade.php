        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Dear {{$user->name}}.
                <br>
              Your Account has been created successfully please reset your password.
            </td>
          </tr>
        </table>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
                <a href = "{{ route('user.reset.password',['token' => $user->token]) }}"> Reset Password </a> 
            </td>
          </tr>
