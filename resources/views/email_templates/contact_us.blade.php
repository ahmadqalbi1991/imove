...
<body style="margin: 0; color: #fff; background: #009CCB;">
    ...
    <div marginwidth="0" marginheight="0" id="" dir="ltr" style="background-color: background: #009CCB;
;margin:0;padding:20px 0 20px 0;width:100%; margin: 0;">

    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%">
        <tbody>
            <tr>
                <td align="center" valign="top" style="">
                    <table border="0" cellpadding="0" cellspacing="0" width="600" style="background-color:#eee;border-radius:10px!important;overflow: hidden;">
                        <tbody>
                            <tr>
                                <td>
                                            ...
                                            <table border="0" cellpadding="20" cellspacing="0" width="100%" style="font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;">
                                                ...
                                                <tr>
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                          <h2 style="color: #000; font-size: 20px;line-height: 100%;">New Contact Form Received</h2>
                                                        <div  style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 30px">
                                                            ...
                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">Name : {{$name}}</p>

                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">Email : {{$email}}</p>


                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">Phone : {{$phone}}</p>


                                                            <p style="margin:0 0 16px; font-size: 14px; line-height: 26px; color: #000; text-align: left;">Message : {{$msg}}</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                                </tbody>
