                                                ...
                                                <tr>
                                                    <td valign="top" style="padding-bottom: 0px;">
                                                        ...
                                                        <div  style="color:#000;font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-size:14px;line-height:150%;text-align:left;margin-top: 0px">
                                                            <h4 style="font-weight: 600; font-size: 18px; color: #000;margin-top: 0;">Hi,  {{$user->first_name.' '.$user->last_name}}</h4>
                                                            <p style="margin:0 0 14px; font-size: 16px; line-height: 26px; color: #000; text-align: left;"> Thank you for booking  with <b>I Move Its</b>! We’re excited to confirm your reservation.</p>
                                                            
                                                            <p style="margin:0 0 14px; font-size: 16px; line-height: 26px; color: #000; text-align: left;">
                                                                Best regards,
                                                                <br>
                                                                I Move It Team
                                                            </p>
